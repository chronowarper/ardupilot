...
void ModeAcro::get_pilot_desired_angle_rates(int16_t roll_in, int16_t pitch_in, int16_t yaw_in, float &roll_out, float &pitch_out, float &yaw_out)
{
    ...
    g.acro_bfrate_rp_rc = constrain_float(g.acro_bf_rp_rc, 0f, 2.55f);
    ...
    if ((g2.acro_options.get() & uint8_t(AcroOptions::BETAFLIGHT_RATES))) {
        ...
        rate_bf_request.x = 200*((rp_in*rp_in*rp_in*rp_in*g.acro_bfrate_rp_expo)+rp_in*(1-g.acro_bfrate_rp_expo))*g.acro_bfrate_rp_rc/(1-(rc_in*g.acro_bfrate_rp_super))

        // pitch expo
        rp_in = float(pitch_in)/ROLL_PITCH_YAW_INPUT_MAX;
        rate_bf_request.y = 200*((rp_in*rp_in*rp_in*rp_in*g.acro_bfrate_rp_expo)+rp_in*(1-g.acro_bfrate_rp_expo))*g.acro_bfrate_rp_rc/(1-(rc_in*g.acro_bfrate_rp_super))
